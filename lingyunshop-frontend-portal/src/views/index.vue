      ...
      <div class="py-container">
        <div class="yui3-g SortList ">
                  ...
                  <div class="subitem">
                    ...
                    <dl class="fore8">
                      ...
                      <dd><em><a href="">科普</a></em><em><a href="">IT</a></em><em><a href="">建筑</a></em><em><a
                          ...
                          href="">农林</a></em><em><a href="">科学与自然</a></em></dd>
                    </dl>
                    <dl class="fore9">
                      <dt>少儿</dt>
          ...
          <div class="yui3-u Right">
            <div class="news">
              <h4><em class="fl">优优购快报</em><span class="fr tip">更多 ></span></h4>
      ...
      <div class="py-container">
        <ul class="yui3-g Recommend">
          ...
          <li class="yui3-u-5-24">
            <a href="list.html" target="_blank"><img src="@/assets/img/today01.png"/></a>
          </li>
          <li class="yui3-u-5-24">
            <img src="@/assets/img/today02.png"/>
          </li>
          <li class="yui3-u-5-24">
            <img src="@/assets/img/today03.png"/>
          </li>
          <li class="yui3-u-5-24">
            <img src="@/assets/img/today04.png"/>
          </li>
        </ul>
      </div>
    </div>
          ...
          <ul class="clearfix yui3-g Favourate picLB" id="picLBxxl">
            <li class="yui3-u-1-6">
              <dl class="picDl huozhe">
                <dd>
                  <a href="" class="pic"><img src="@/assets/img/like_02.png" alt=""/></a>
                  <div class="like-text">
                ...
                <dd>
                  <a href="" class="pic"><img src="@/assets/img/like_01.png" alt=""/></a>
                  <div class="like-text">
            ...
            <li class="yui3-u-1-6">
              <dl class="picDl jilu">
                <dd>
                  <a href="" class="pic"><img src="@/assets/img/like_03.png" alt=""/></a>
                  <div class="like-text">
                    <p>爱仕达 30CM炒锅不粘锅NWG8330E电磁炉炒</p>
                    <h3>¥116.00</h3>
                  </div>
            ...
            <li class="yui3-u-1-6">
              <dl class="picDl tuhua">
                ...
                <dd>
                  <a href="" class="pic"><img nsrc="assets/@/assets/img/like_02.png" alt=""/></a>
                  <div class="like-text">
                    <p>三星（G5500）</p>
                    <p>移动联通双网通</p>
                    <h3>¥566.00</h3>
            ...
            <li class="yui3-u-1-6">
              <dl class="picDl jilu">
                <dd>
                  <a href="http://sc.chinaz.com/" class="pic"><img src="@/assets/img/like_03.png" alt=""/></a>
                  <div class="like-text">
                    <p>捷波朗 </p>
                    <p>（jabra）BOOSI劲步</p>
                    <h3>¥236.00</h3>
                ...
                <dd>
                  <a href="http://sc.chinaz.com/" class="pic"><img src="@/assets/img/like_02.png" alt=""/></a>
                  <div class="like-text">
                    <p>欧普</p>
                    <p>JYLZ08面板灯平板灯铝</p>
                    <h3>¥456.00</h3>
            ...
            <li class="yui3-u-1-6">
              <dl class="picDl tuhua">
                <dd>
                  <a href="http://sc.chinaz.com/" class="pic"><img src="@/assets/img/like_01.png" alt=""/></a>
                  <div class="like-text">
                    <p>三星（G5500）</p>
                    <p>移动联通双网通</p>
                    <h3>¥566.00</h3>
                ...
                <dd>
                  <a href="http://sc.chinaz.com/" class="pic"><img nsrc="assets/@/assets/img/like_02.png" alt=""/></a>
                  <div class="like-text">
      ...
      <div class="py-container">
        ...
        <div class="clearfix yui3-g Interest">
          ...
          <div class="yui3-u row-405 Interest-conver">
            <img src="@/assets/img/interest01.png"/>
          </div>
          <div class="yui3-u row-225 Interest-conver-split">
            <h5>好东西</h5>
            <img src="@/assets/img/interest02.png"/>
            <img src="@/assets/img/interest03.png"/>
          </div>
          <div class="yui3-u row-405 Interest-conver-split blockgary">
            <h5>品牌街</h5>
            <div class="split-bt">
              <img src="@/assets/img/interest04.png"/>
            </div>
            <div class="x-img fl">
              <img src="@/assets/img/interest05.png"/>
            </div>
            <div class="x-img fr">
              <img src="@/assets/img/interest06.png"/>
            </div>
          </div>
          <div class="yui3-u row-165 brandArea">
            <span class="brand-yline"></span>
            <ul class="yui3-g brand-list">
              <li class="yui3-u-1-2 brand-pit"><img src="@/assets/img/brand01.png"/></li>
              <li class="yui3-u-1-2 brand-pit"><img src="@/assets/img/brand02.png"/></li>
              <li class="yui3-u-1-2 brand-pit"><img src="@/assets/img/brand03.png"/></li>
              <li class="yui3-u-1-2 brand-pit"><img src="@/assets/img/brand04.png"/></li>
              <li class="yui3-u-1-2 brand-pit"><img src="@/assets/img/brand05.png"/></li>
              <li class="yui3-u-1-2 brand-pit"><img src="@/assets/img/brand06.png"/></li>
              <li class="yui3-u-1-2 brand-pit"><img src="@/assets/img/brand07.png"/></li>
              <li class="yui3-u-1-2 brand-pit"><img src="@/assets/img/brand08.png"/></li>
              <li class="yui3-u-1-2 brand-pit"><img src="@/assets/img/brand09.png"/></li>
              <li class="yui3-u-1-2 brand-pit"><img src="@/assets/img/brand10.png"/></li>
              <li class="yui3-u-1-2 brand-pit"><img src="@/assets/img/brand11.png"/></li>
              <li class="yui3-u-1-2 brand-pit"><img src="@/assets/img/brand12.png"/></li>
              <li class="yui3-u-1-2 brand-pit"><img src="@/assets/img/brand13.png"/></li>
              <li class="yui3-u-1-2 brand-pit"><img src="@/assets/img/brand03.png"/></li>
            </ul>
          </div>
        </div>
          ...
          <div id="tab1" class="tab-pane active">
            <div class="yui3-g Floor-1">
              <div class="yui3-u Left blockgary">
                ...
                <img src="@/assets/img/floor-1-1.png"/>
              </div>
              <div class="yui3-u row-330 floorBanner">
                <div id="floorCarousel" data-ride="carousel" data-interval="4000" class="sui-carousel slide">
                  ...
                  <div class="carousel-inner">
                    <div class="active item">
                      <img src="@/assets/img/floor-1-b01.png">
                    </div>
                    <div class="item">
                      <img src="@/assets/img/floor-1-b02.png">
                    </div>
                    <div class="item">
                      <img src="@/assets/img/floor-1-b03.png">
                    </div>
                  </div>
              ...
              <div class="yui3-u row-220 split">
                ...
                <div class="floor-conver-pit">
                  <img src="@/assets/img/floor-1-2.png"/>
                </div>
                <div class="floor-conver-pit">
                  <img src="@/assets/img/floor-1-3.png"/>
                </div>
              </div>
              <div class="yui3-u row-218 split">
                <img src="@/assets/img/floor-1-4.png"/>
              </div>
              <div class="yui3-u row-220 split">
                <span class="floor-x-line"></span>
                <div class="floor-conver-pit">
                  <img src="@/assets/img/floor-1-5.png"/>
                </div>
                <div class="floor-conver-pit">
                  <img src="@/assets/img/floor-1-6.png"/>
                </div>
              </div>
            </div>
          </div>
    ...
    <div class="brand">
      <div class="py-container">
        <ul class="Brand-list blockgary">
          <li class="Brand-item">
            <img src="@/assets/img/brand_21.png"/>
          </li>
          <li class="Brand-item"><img src="@/assets/img/brand_03.png"/></li>
          <li class="Brand-item"><img src="@/assets/img/brand_05.png"/></li>
          <li class="Brand-item"><img src="@/assets/img/brand_07.png"/></li>
          <li class="Brand-item"><img src="@/assets/img/brand_09.png"/></li>
          <li class="Brand-item"><img src="@/assets/img/brand_11.png"/></li>
          <li class="Brand-item"><img src="@/assets/img/brand_13.png"/></li>
          <li class="Brand-item"><img src="@/assets/img/brand_15.png"/></li>
          <li class="Brand-item"><img src="@/assets/img/brand_17.png"/></li>
          <li class="Brand-item"><img src="@/assets/img/brand_19.png"/></li>
        </ul>
      </div>
    </div>
    <!-- 底部栏位 -->
      ...
      <div class="py-container">
        <div class="footlink">
          ...
          <div class="Mod-copyright">
            ...
            <p>地址：北京市海淀区中关村南大街36号12号楼18层1801号260 邮编：100096 电话：400-618-4100 传真：010-82885100</p>
            <p>京ICP备18026820号京公网安备</p>
          </div>
        </div>
      </div>
    </div>
              ...
              <div class="tbar-panel-main">
                <div class="tbar-panel-content J-panel-content">
                  <div class="jt-history-wrap">
                    <ul>
                      <!--<li class="jth-item">
                        <a href="#" class="img-wrap"> <img src=".portal/@/assets/img/like_03.png" height="100" width="100" /> </a>
                        <a class="add-cart-button" href="#" target="_blank">加入购物车</a>
                        <a href="#" target="_blank" class="price">￥498.00</a>
                      </li>
                      <li class="jth-item">
                        <a href="#" class="img-wrap"> <img src="portal/@/assets/img/like_02.png" height="100" width="100" /></a>
                        <a class="add-cart-button" href="#" target="_blank">加入购物车</a>
                        <a href="#" target="_blank" class="price">￥498.00</a>
                      </li>-->
                    </ul>
...
<script type="text/javascript" src="@/assets/js/model/cartModel.js"></script>
<script type="text/javascript" src="@/assets/js/czFunction.js"></script>
...
<script type="text/javascript" src="@/assets/js/widget/cartPanelView.js"></script>
<script type="text/javascript" src="@/assets/js/widget/jquery.autocomplete.js"></script>
...
<style src="../assets/css/webbase.css"></style>
<style src="../assets/css/pages-JD-index.css"></style>
<!--<style src="../assets/css/widget-jquery.autocomplete.css"></style>-->
<style src="../assets/css/widget-cartPanelView.css"></style>
<style scoped>
