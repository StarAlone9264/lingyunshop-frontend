            ...
            <div class="tab-pane active" id="home">
              <div class="row data-type">
                ...
                <div class="col-md-10 data">
                  <input type="text" class="form-control" placeholder="商家编号" value="">
                </div>
                ...
                <div class="col-md-10 data">
                  <input type="text" class="form-control" placeholder="店铺名称" value="">
                </div>
                ...
                <div class="col-md-10 data">
                  <input type="text" class="form-control" placeholder="邮箱" value="">
                </div>
                ...
                <div class="col-md-2 title">联系地址</div>
                <div class="col-md-10 data">
                  <input type="text" class="form-control" placeholder="联系地址" value="">
                </div>

                <div class="col-md-2 title">公司logo</div>
                <div class="col-md-10 data">
                  <input type="text" class="form-control" placeholder="公司图标" value="">
                </div>

                <div class="col-md-2 title">公司简介</div>
                <div class="col-md-10 data">
                  <input type="text" class="form-control" placeholder="公司简介" value="">
                </div>
